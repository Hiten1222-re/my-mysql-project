...
update layoffs2 set location='Florianapolis'
...
update layoffs2 set location='Malmo'
where location='Malm̦'
;

select distinct industry from layoffs2 order by industry;

select * from layoffs2 where isnull(industry);
